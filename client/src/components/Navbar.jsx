...
const Navbar = ({
    ...
    const startVoiceSearch = () => {
        ...
        recognition.lang = 'it-IT'; // Default to Italian, can be adjusted
        ...
        recognition.onresult = (event) => {
            ...
            setIsListening(true); // Keep UI feedback for a moment
            setTimeout(() => {
